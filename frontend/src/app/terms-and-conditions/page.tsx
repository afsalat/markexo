        ...
        <div className="min-h-screen bg-dark-900 py-12">
            <div className="container mx-auto px-4 max-w-4xl">
                ...
                <div className="prose prose-invert max-w-none space-y-6">
                    ...
                    <section className="bg-dark-800 border border-dark-700 rounded-xl p-6">
                        <h2 className="text-xl font-bold text-white mb-4">2. Product Orders</h2>
                    ...
                    <section className="bg-dark-800 border border-dark-700 rounded-xl p-6">
                        <h2 className="text-xl font-bold text-white mb-4">3. Cash on Delivery (COD)</h2>
                        <ul className="text-silver-400 space-y-2 list-disc list-inside">
                    ...
                    <section className="bg-dark-800 border border-dark-700 rounded-xl p-6">
                        <h2 className="text-xl font-bold text-white mb-4">4. Delivery</h2>
                        <ul className="text-silver-400 space-y-2 list-disc list-inside">
                    ...
                    <section className="bg-dark-800 border border-dark-700 rounded-xl p-6">
                        <h2 className="text-xl font-bold text-white mb-4">5. Returns & Refunds</h2>
                        <p className="text-silver-400 leading-relaxed">
                            Please refer to our <Link href="/return-refund-policy" className="text-accent-500 hover:underline">Return & Refund Policy</Link> for
