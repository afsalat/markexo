        ...
        <div className="min-h-screen bg-gray-50 dark:bg-dark-950 text-gray-700 dark:text-silver-300 py-16 px-4">
            <div className="container mx-auto max-w-4xl">
                <div className="bg-white dark:bg-dark-800 border border-gray-100 dark:border-dark-600 rounded-2xl p-8 md:p-12 shadow-sm dark:shadow-2xl">
                    <h1 className="font-display text-3xl md:text-4xl font-bold text-gray-900 dark:text-white mb-2">Terms & Conditions</h1>
                    <p className="text-gray-400 dark:text-silver-500 mb-8">Last Updated: January 01, 2026</p>
                    ...
                    <div className="space-y-8 text-gray-700 dark:text-silver-300 leading-relaxed">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">1. About VorionMart</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">3. Products & Pricing</h2>
                            <ul className="list-disc pl-5 space-y-2">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">4. Payment Policy (Cash on Delivery – COD)</h2>
                            <div className="p-4 bg-primary-50 dark:bg-accent-500/10 border border-primary-100 dark:border-accent-500/30 rounded-xl mb-4">
                                <p className="text-primary-700 dark:text-white font-medium">VorionMart operates on a STRICT Cash on Delivery (COD) only model.</p>
                            </div>
                            <ul className="list-disc pl-5 space-y-2">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">5. Order Confirmation & Verification</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">7. Return to Origin (RTO) Policy</h2>
                            ...
                            <div className="p-4 bg-red-50 dark:bg-red-500/10 border border-red-100 dark:border-red-500/30 rounded-xl">
                                <p className="font-bold text-red-600 dark:text-red-400 mb-1">Important Notice:</p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">8. Order Cancellation</h2>
                            <ul className="list-disc pl-5 space-y-2">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">9. Returns & Refunds</h2>
                            <ul className="list-disc pl-5 space-y-2">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">10. Customer Responsibilities</h2>
                            ...
                            <p className="mt-2 text-red-600 dark:text-red-400">Violation may result in account blocking and legal action if necessary.</p>
                        </section>

                        <section>
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">11. Intellectual Property Rights</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">13. Changes to Terms</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">14. Governing Law & Jurisdiction</h2>
                            <p>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-3">16. Platform Ownership & Technology</h2>
                            <p>
                            ...
                            <p className="mt-2 text-sm text-gray-500 dark:text-silver-500">
