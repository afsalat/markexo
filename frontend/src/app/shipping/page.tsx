        ...
        <div className="min-h-screen bg-dark-900 text-silver-300 py-16 px-4">
            <div className="container mx-auto max-w-4xl">
                <div className="bg-dark-800 border border-dark-600 rounded-2xl p-8 md:p-12 shadow-2xl">
                    <h1 className="font-display text-3xl md:text-4xl font-bold text-white mb-8">Shipping Policy</h1>

                    <div className="space-y-8 text-silver-300 leading-relaxed">
                        <section>
                            <h2 className="text-xl font-bold text-white mb-3">Shipping Locations</h2>
                            <p>Currently shipping across India.</p>
                        </section>

                        <section>
                            <h2 className="text-xl font-bold text-white mb-3">Delivery Timeline</h2>
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-white mb-3">Shipping Charges</h2>
                            <ul className="list-disc pl-5 space-y-2">
                        ...
                        <section>
                            <h2 className="text-xl font-bold text-white mb-3">Delivery Attempts</h2>
                            <ul className="list-disc pl-5 space-y-2">
