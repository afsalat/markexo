...
export default function CheckoutPage() {
    ...
    const { customer, isAuthenticated, isLoading, addresses, loginWithGoogle } = useCustomerAuth();
                        ...
                        <form onSubmit={handleSubmit}>
                            {step === 1 && (
                                <div className="bg-white border border-gray-100 shadow-sm rounded-2xl p-6 md:p-8 animate-fade-in">
                                    ...
                                    {!isAuthenticated ? (
                                        <div className="mb-8 rounded-2xl border border-accent-100 bg-accent-50/50 p-5 shadow-sm">
                                            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                                                <div>
                                                    <p className="font-bold text-gray-900">Quick login for faster checkout</p>
                                                    <p className="mt-1 text-sm font-medium text-gray-600">
                                                        Continue with Google to auto-fill your account email and keep order tracking connected.
                                                    </p>
                                                </div>
                                                <button
                                                    type="button"
                                                    ...
                                                    className="inline-flex items-center justify-center gap-2 rounded-xl border border-gray-200 bg-white px-5 py-3 text-sm font-bold text-gray-800 shadow-sm transition-all hover:bg-gray-50 disabled:cursor-not-allowed disabled:opacity-60"
                                                >
                                        ...
                                        <div className="mb-8 rounded-2xl border border-green-100 bg-green-50 p-4 shadow-sm">
