                ...
                <div className="flex min-h-[64px] md:min-h-[80px] items-center gap-3 lg:gap-6">
                    ...
                    <nav className="hidden items-center gap-7 lg:flex">
                        ...
                        >
                            ...
                            {/* Mega Menu Overlay */}
                            <div className={`fixed left-0 w-full top-[64px] md:top-[80px] transition-all duration-300 origin-top shadow-2xl z-[60] border-t border-gray-100 ${isCategoryDropdownOpen ? 'opacity-100 scale-y-100 visible pointer-events-auto' : 'opacity-0 scale-y-95 invisible pointer-events-none'}`}>
                                <div className="bg-white w-full max-h-[calc(100vh-84px)] overflow-y-auto">
